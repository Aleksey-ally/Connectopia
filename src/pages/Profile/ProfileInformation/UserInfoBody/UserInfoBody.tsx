            ...
            <ul className={s.personalInfoTable}>
                <li>
                    <div>
                        ...
                        <Typography variant={'h3'} as={'div'} id={'fullName'} onDoubleClick={enableEditForm}>{profile?.fullName}</Typography>
                    </div>
                </li>
                ...
                <li>
                    <div>
                        ...
                        <Typography key={c} onDoubleClick={enableEditForm}>{profile.contacts[c] || 'не указано'}</Typography>
                    ))) || null}
                    </div>
                </li>
